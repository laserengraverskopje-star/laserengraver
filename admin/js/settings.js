...
async function save(){
 ...
 if(adminChanged)settings.admin_username=username; if(newPassword)settings.admin_password=newPassword; settings.adminAutoRefresh=autoRefresh.value;
